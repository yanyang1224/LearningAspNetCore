...
using Acme.MongoDB.BookStore.Data;
using Serilog;
...
#if DEBUG
                .MinimumLevel.Override("Acme.MongoDB.BookStore", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("Acme.MongoDB.BookStore", LogEventLevel.Information)
#endif
