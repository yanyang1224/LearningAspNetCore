...
using Invengo.Library.ISBNUtility.Model;
using Newtonsoft.Json;

namespace Invengo.Library.ISBNUtility
{
	public class Recognizer
	{
		...
		public static VERSION RecognizeISBN(string isbn)
		{
		...
		/// <returns></returns>
		public static string hyphenateISBN(string isbn)
		{
			isbn = SanitizeISBN(isbn);
		...
		/// <returns></returns>
		public static string GetCountryFromNumber(string number)
		{
			var loader = LoadISBNRanges();
			var country = "";
