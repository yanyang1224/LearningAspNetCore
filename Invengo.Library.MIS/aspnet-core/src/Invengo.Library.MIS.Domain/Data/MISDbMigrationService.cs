...
{
    public class MISDbMigrationService : ITransientDependency
    {
        public ILogger<MISDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IMISDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public MISDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IMISDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<MISDbMigrationService>.Instance;
        }
